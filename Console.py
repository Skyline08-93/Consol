# triangle_bybit_bot.py — торговый бот с улучшенной обработкой баланса
...
balance_warning_sent = False  # Флаг предупреждения о балансе
...
async def main():
    ...
    global trade_limits_suspended, balance_warning_sent
